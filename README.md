...
Bu repository, FinTechBankX DDD/EDA dönüşümünde **svc-gov-architecture-runbooks** servis yetkinliğinin kaynak kodunu, kontratlarını ve operasyonel guardrail'lerini içerir.
...
| Squad | Architecture Board |
| Repo Kümesi (Capability) | governance |
| Service ID | svc-gov-architecture-runbooks |
| Bounded Context | architecture_runbooks |
| Wave | 4 |
...
## Kapsam
### In Scope
- architecture_runbooks bağlamına ait uygulama kodu, testler ve otomasyon.
